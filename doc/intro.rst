...
musical instruments, which typically all have the same definition of notes but
produce different sounds.

.. rubric:: Scales

In order to use actual musical notes, there are some **scales** which will
...
can be used to create conventional scales (tempered, diatonic) but also to
experiment with new ideas using arbitrary ratios.
...
interpolated numbers.  There are endless ways to use it within Splat but also
